...
import { Cart } from '../base/utils/Cart';
...
import miniCartSelector from '../base/fixtures/during/selectors/minicart.json';
import miniCartExpected from '../base/fixtures/verify/expects/minicart.json';

import productSelector from '../base/fixtures/during/selectors/product-page.json';
